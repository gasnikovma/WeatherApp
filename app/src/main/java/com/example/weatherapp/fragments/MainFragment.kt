...
const val API_KEY="ea2adddf11c14cfc81f81017231208"
class MainFragment : Fragment() {
    ...
    private fun updateCurrentCard()= with(binding){
        model.liveDataCurrent.observe(viewLifecycleOwner){
                ...
                tvData.text=it.time
                tvCity.text=it.city
                tvCurTemp.text=it.currentTemp.ifEmpty{ maxMinTemp}
    ...
    private fun requestWeatherData(city:String){
        ...
        val request=StringRequest(
            ...
            url,
            {
                    result-> parseResultWeather(result)
            },
            {
    ...
    private fun parseResultWeather(result:String){
